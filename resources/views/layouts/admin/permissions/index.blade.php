                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-6 ">
                                <a href="{{ route('admin.permissions.create') }}" class="btn btn-success float-end"><i class="fa fa-plus-circle"></i> Novo permissão</a>
                            </div>
                            </div>
                                            ...
                                            @if($permissions)
                                                @foreach($permissions as $permission)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.permissions.show',$permission->id) }}" data-method="GET" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" class="btn btn-sm btn-info j_info_modal"><i class="ri-file-search-line"></i> Detalhes</a>
                                                            <a href="{{ route('admin.permissions.profiles',$permission->id) }}" class="btn btn-sm btn-success"><i class="ri-account-circle-line"></i> Perfis</a>
                                                            <a href="{{ route('admin.permissions.edit',$permission->id) }}" class="btn btn-sm btn-warning"><i class="ri-edit-line"></i> Editar</a>
