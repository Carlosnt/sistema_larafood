                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-6 ">
                                <a href="{{ route('profiles.create') }}" class="btn btn-success float-end"><i class="fa fa-plus-circle"></i> Novo perfil</a>
                            </div>
                            </div>
{{--                            <div class="col-md-12">--}}
                                            ...
                                            @if($profiles)
                                                @foreach($profiles as $profile)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('profiles.show',$profile->id) }}" class="btn btn-sm btn-success">Add detalhes</a>
                                                            <a href="{{ route('profiles.edit',$profile->id) }}" class="btn btn-sm btn-warning">Editar</a>
                                                            <a href="#"  class="btn btn-sm btn-danger j_delete_modal"
                                                               data-bs-toggle="modal"
                                                               data-bs-target="#deletePlan"
                                                               data-url="{{ route('profiles.delete', $profile->id) }}"
                                                               data-action="DELETE"
                                                               data-name="{{ $profile->name }}"
                                                               data-id="{{ $profile->id }}">Deletar</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
