                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-6 ">
                                <a href="{{ route('admin.plans.create') }}" class="btn btn-success float-end"><i class="fa fa-plus-circle"></i> Novo plano</a>
                            </div>
                            </div>
                                            ...
                                            @if($plans)
                                                @foreach($plans as $plan)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.plans.show',$plan->id) }}" data-method="GET" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" class="btn btn-sm btn-outline-info j_info_modal"><i class="ri-file-search-line"></i> Info</a>
                                                            <a href="{{ route('admin.details.plan.index',$plan->url) }}" class="btn btn-sm btn-info"><i class="ri-money-dollar-circle-line"></i> Add Detalhes</a>
                                                            <a href="{{ route('admin.plans.profiles',$plan->id) }}" class="btn btn-sm btn-success"><i class="ri-money-dollar-circle-line"></i> Add Perfil</a>
                                                            <a href="{{ route('admin.plans.edit',$plan->id) }}" class="btn btn-sm btn-warning"><i class="ri-edit-line"></i> Editar</a>

                                                            <a href="#"  class="btn btn-sm btn-danger j_delete_modal"
                                                               data-bs-toggle="modal"
                                                               data-bs-target="#deletePlan"
                                                               data-url="{{ route('admin.plans.delete',['plan' => $plan->id]) }}"
                                                               data-method="DELETE"
                                                               data-name="{{ $plan->name }}"
                                                               data-id="{{ $plan->id }}"><i class="ri-delete-bin-5-line"></i> Deletar</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                let html =
                                    ...
                                    '<p>Confira os detalhes de: <span id="name_modal" style="font-weight: bold">' + response.name + '</span></p>\n' +
                                    '<ul>\n' +
