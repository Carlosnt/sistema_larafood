...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenants', function (Blueprint $table) {
            ...
            // Subscription
            $table->date('subscription')->nullable(); // Data de incrição
            $table->date('expired_at')->nullable(); // Data de expira o acesso
            $table->string('subscription_id', 255)->nullable(); //Identificado pelo Gatway de pagamento
